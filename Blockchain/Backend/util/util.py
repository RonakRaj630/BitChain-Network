...
def encode_varient(i):
    if i< 0xfd:
        ...
        raise ValueError('Integer too larger: {}'.format(i))

def merkle_parent_level(hashes):
    """takes a list of binary hashes and return a list of half of length"""
    if len(hashes)%2 == 1:
...
def merkle_root(hashes):
    """Takes a list of Binary hashes and return merkle root"""
